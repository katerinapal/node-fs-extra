describe(
  ...
  () => {
    test("invoc-loc:36:3:36:55-test:0", () => {
      ...
      var arg0 = "fs-extra/copy-sync-symlinks/src";
    ...
    test("invoc-loc:36:3:36:55-test:1", () => {
      ///home/katerina/visualStudioGit/evaluationProjects/node-fs-extra/lib/move/move-sync.js:8:1:8:36
      var stat = require("../lib/util/stat");
      ///home/katerina/visualStudioGit/evaluationProjects/node-fs-extra/filtered-test-modules/node-fs-extra-test-code-merged-entryfile.js:7:1:7:50
      var copySync = require("../lib/copy/copy-sync.js");
      var arg0 = "fs-extra/copy-sync-symlinks/src";
